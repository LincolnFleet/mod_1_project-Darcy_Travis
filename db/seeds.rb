...
kellog = Character.create(name: "Kellog Tubbybuddy", level: 3, char_class: "Rogue", race: "Orc")
lockheim = Character.create(name: "Lockheim Superiorace", level: 1, char_class: "Ranger", race: "Elf")
chad = Character.create(name: "Chad Brosef", level: 5, char_class: "Barbarian", race: "Human")
...
kellog_inv1 = Inventory.create(character_id: kellog.id, equipment_id: lamp.id)
lockheim_inv1 = Inventory.create(character_id: lockheim.id, equipment_id: crossbow.id)
chad_inv1 = Inventory.create(character_id: chad.id, equipment_id: javelin.id)
chad_inv2 = Inventory.create(character_id: chad.id, equipment_id: lamp.id)
